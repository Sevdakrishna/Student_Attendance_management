...
<head>
    ...
    <link href="img/logo/indira.jpg" rel="icon">
    <title>ICEM - Login</title>
                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    <div class="text-center">
                                        <img src="img/logo/indira.jpg" style="width:100px;height:100px">
                                        <br><br>
...
?>
                    ...
                    <a href="index.html" class="btn btn-facebook btn-block">
                      <i class="fab fa-facebook-f fa-fw"></i> Login with Facebook
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="font-weight-bold small" href="classTeacherLogin.php">Subject teacher Login!</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
